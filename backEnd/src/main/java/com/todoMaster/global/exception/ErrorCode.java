...
public enum ErrorCode {
    ...
    // 공통
    FILE_MOVE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "파일 처리 중 오류가 발생했습니다.",""),
    
    // S3 / 인프라
    PRESIGNED_URL_GENERATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "이미지 업로드에 실패했습니다","서버 통신 문제로 인해 파일을 업로드할 수 있는 주소를 생성하지 못했습니다. 잠시 후 다시 시도해주시거나, 문제가 지속될 경우 서비스 지원팀에 문의해 주세요."),
